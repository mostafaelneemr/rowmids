<!--begin::Subheader-->
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader" style="background: #FFF;">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <div class="d-flex align-items-baseline mr-5">
                ...
                <div class="text-dark font-weight-bold my-2 mr-5">
        ...
        <div class="d-flex align-items-center flex-wrap">
            @if(isset($add_new))
                <a href="{{route($add_new['route'])}}" class="btn btn-icon btn-outline-primary mr-2" target="_blank">
