...
@section('content')
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0"> Fontawesome Icon </h4>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section>
                                <h5 class="card-title">41 New Icons in 4.7 </h5>
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section>
                                <h5 class="card-title">30 New Icons in 4.6.3 </h5>
                                <div class="icon-list-demo row">
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section>
                                <h5 class="card-title">20 New Icons in 4.5 </h5>
                                <div class="icon-list-demo row">
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section>
                                <h5 class="card-title">66 Icons in 4.4 </h5>
                                <div class="icon-list-demo row">
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section>
                                <h5 class="card-title">40 Icons in 4.3 </h5>
                                <div class="icon-list-demo row">
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section id="new-icons">
                                <h5 class="card-title">40 Icons in 4.2</h5>
                                <div class="icon-list-demo row">
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section id="file-type">
                                <h5 class="card-title">File Type Icons</h5>
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section id="form-control">
                                <h5 class="card-title">Form Control Icons</h5>
                                <div class="row icon-list-demo">
                                    <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-check-square"></i> fa-check-square</div>
                                    <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-check-square-o"></i> fa-check-square-o</div>
                                    <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-circle"></i> fa-circle</div>
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section id="currency">
                                <h5 class="card-title">Currency Icons</h5>
                                <div class="row icon-list-demo">
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section id="directional">
                                <h5 class="card-title">Directional Icons</h5>
                                <div class="row icon-list-demo">
                    ...
                    <div class="card card-statistics mb-30">
                        <div class="card-body">
                            <section id="video-player">
                                <h5 class="card-title">Video Player Icons</h5>
                                <div class="row icon-list-demo">
                                    <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
                    ...
                    <div class="card card-statistics">
                        <div class="card-body">
                            <section id="medical">
                                <h5 class="card-title">Medical Icons</h5>
                                <div class="row icon-list-demo">
