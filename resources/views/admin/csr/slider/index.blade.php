           ...
           @include('admin.message')
            ...
            <div class="card">
                <div class="card-header">
                    <h3> Sliders
                        @if (\App\Models\admin\Slider::where('slider_type' , 'corporate')->count() < 1)
                            <a href="{{route('csr-slider.create')}}" class="btn btn-primary text-white float-start m-4">Add Slider</a>
                        @endif
                    </h3>
                </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered p-0 text-center table-hover">
                        ...
                        @foreach($sliders as $slider)
                            <tr>
                                ...
                                <td width="18%">
                                    <a href="{{route('csr-slider.edit', $slider->id)}}" class="btn btn-info btn-sm" title="Edit" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                    <a href="javascript:void(0);" onclick="deleteSlider( '{{route('csr-slider.destroy', $slider->id )}}')" class="btn btn-danger btn-sm" title="delete" role="button" aria-pressed="true"><i class="fa fa-trash"></i></a>
