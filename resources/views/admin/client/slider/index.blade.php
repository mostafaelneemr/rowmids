           ...
           @include('admin.message')
            ...
            <div class="card">
                <div class="card-header">
                    <h3> Sliders
                        @if (\App\Models\admin\Slider::where('slider_type' , 'client')->count() < 1)
                            <a href="{{route('client-slider.create')}}" class="btn btn-primary text-white float-start m-4">Add Slider</a>
                        @endif
                    </h3>
                </div>
