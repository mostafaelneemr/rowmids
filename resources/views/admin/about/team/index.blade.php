                        ...
                        @foreach($teams as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0);" onclick="deleteSlider( '{{route('teams.destroy', $item->id )}}')" class="btn btn-danger btn-sm" title="delete" role="button" aria-pressed="true"><i class="fa fa-trash"></i></a>
